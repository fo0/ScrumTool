...
import com.fo0.vaadin.scrumtool.export.JiraMarkDown;
import com.fo0.vaadin.scrumtool.export.VanillaMarkDown;
...
public class MarkDownDialog extends Dialog {
	...
	private void init() {
		...
		header.add(createBtnJiraMarkdown());
	...
	private Button createBtnCommonMarkdown() {
		Button btnCommonMarkdown= new Button("Markdown");
